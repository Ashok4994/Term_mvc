 ...
 * @author ashok
 */
@WebServlet(name = "ViewFiles", urlPatterns = {"/ViewFiles"})
public class ViewFiles extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<FileBean> file_list = new ArrayList<FileBean>();
        
        try {
            file_list=FileService.getfile(dir_id);
        } catch (SQLException ex) {
            Logger.getLogger(ViewFiles.class.getName()).log(Level.SEVERE, null, ex);
        }
        request.setAttribute("file_list",file_list);
         request.getRequestDispatcher("view_files.jsp").forward(request, response);
    }
